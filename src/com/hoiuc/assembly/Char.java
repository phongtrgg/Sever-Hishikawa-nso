...
public class Char extends Body {
    ...
    public void flush() {
        ...
        try {
            synchronized(Server.LOCK_MYSQL) {
                ...
                String sqlSET = "`head`=" + this.head +",`caiTrang`=" + this.caiTrang +",`rankTDB`=" + this.rankTDB +",`countWin`=" + this.countWin +",`countTDB`=" + this.countTDB + ",`isGiftTDB`=" + this.isGiftTDB + ", `taskId`=" + this.taskId + ",`class`=" + this.get().nclass + ",`ppoint`=" + this.get().ppoint + ",`potential0`=" + this.get().potential0 + ",`potential1`=" + this.get().potential1 + ",`potential2`=" + this.get().potential2 + ",`potential3`=" + this.get().potential3 + ",`spoint`=" + this.get().spoint + ",`level`=" + this.get().level + ",`exp`=" + this.exp + ",`expdown`=" + this.expdown + ",`expSkillClone`=" + this.expSkillClone + ",`pk`=" + this.pk + ",`xu`=" + this.xu + ",`yen`=" + this.yen + ",`maxluggage`=" + this.maxluggage + ",`levelBag`=" + this.levelBag + ",`site`='" + jarr.toJSONString() + "', `buyX3` =" + this.countBuyX3;
                jarr.clear();
    ...
    public void upluongMessage(long l) {
